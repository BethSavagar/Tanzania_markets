...
mrktc_general <- read_csv(here("tanzania_data/mrktc_generalinfo_tanzania.csv"))
...
# write.csv(mrktc_names, "mrktc_names_clean1.csv", row.names = F) # stored in tanzania_data file
...
mrktc_names_clean1 <- read_excel("~/OneDrive - Royal Veterinary College/4. tanzania_markets_2/tanzania_data/mrktc_names_clean1.xlsx", 
...
mrktc_names_clean2 <- read_excel("~/OneDrive - Royal Veterinary College/4. tanzania_markets_2/tanzania_data/mrktc_names_clean1.xlsx", 
...
mrkta_names_x2 <- read_csv("tanzania_data/mrkta_names_crossref2.csv") 
mrktc_names_post2 <- read_csv("tanzania_data/mrktc_names_clean3.csv")
...
mrkta_gps_CLEAN <- read_csv("tanzania_data/mrkta_gps_tanzania_CLEAN.csv") 
# mrkta mapdata
...
mrktc_names_clean3 <- read_excel("~/OneDrive - Royal Veterinary College/4. tanzania_markets_2/tanzania_data/mrktc_names_clean1.xlsx", 
...
# SAVE DATA
write.csv(mrktc_names_post3, file = "mrktc_names_clean3-1.csv", row.names = F)
write.csv(mrktc_clean3, file = "mrktc_info_clean3-1.csv", row.names = F)
```
...
# write.csv(mrktc_multiwards, file = "mrktc_names-multiwards_clean3.csv", row.names = F)
